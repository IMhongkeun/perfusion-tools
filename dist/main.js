...
const cannulaPressureDropData = [
  ...
  },
  {
    ...
    points: [
      { flow: 0.3939412750636291, pressureDrop: 10.12632689800732 },
      { flow: 0.48542222774018673, pressureDrop: 14.814182548058028 },
      { flow: 0.7398452210979374, pressureDrop: 29.97806609141888 },
      { flow: 0.8830467440561178, pressureDrop: 40.143708485939534 },
      { flow: 1.0060421710431022, pressureDrop: 52.35013553500114 },
      { flow: 1.0969023527220811, pressureDrop: 60.17288472282575 },
      { flow: 1.1939598981935564, pressureDrop: 70.0322800918741 },
      { flow: 1.2778157137831856, pressureDrop: 79.89374469758107 },
      { flow: 1.3682723943137378, pressureDrop: 89.75417468495871 },
      { flow: 1.4455273449624433, pressureDrop: 99.61667390899497 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.48046640594284784, pressureDrop: 6.5077492912864585 },
      { flow: 1.0054317462288163, pressureDrop: 22.09944751381215 },
      { flow: 1.1952738634717655, pressureDrop: 30.063422103585992 },
      { flow: 1.4959960270656154, pressureDrop: 44.749829287975665 },
      { flow: 1.7504500589732452, pressureDrop: 59.756968154447826 },
      { flow: 1.9912678213007227, pressureDrop: 76.96060173402032 },
      { flow: 2.180147743497424, pressureDrop: 89.78366130734372 },
      { flow: 2.3101785751236372, pressureDrop: 99.79462826163429 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.4707259953161592, pressureDrop: 6.833333333333343 },
      { flow: 0.9906323185011708, pressureDrop: 23.000000000000014 },
      { flow: 1.1733021077283374, pressureDrop: 30.16666666666667 },
      { flow: 1.4964871194379392, pressureDrop: 45.33333333333334 },
      { flow: 1.7423887587822016, pressureDrop: 60.33333333333334 },
      { flow: 1.8899297423887589, pressureDrop: 70.33333333333334 },
      { flow: 1.988290398126464, pressureDrop: 77 },
      { flow: 2.177985948477752, pressureDrop: 90.33333333333334 }
    ],
  ...
  },
  {
    ...
    testMedium: 'Water',
    dataStatus: 'digitized-curve',
    digitizationNote: 'Digitized manually from manufacturer-published pressure-loss chart; values rounded for practical reference use. Flow values are preserved with source precision where available.',
    outOfRangeMessage: 'Target flow is outside the digitized manufacturer chart range. Pressure drop is not estimated.',
    referenceFlowRangeLabel: '0.46–3.00',
    points: [
      { flow: 0.46370023419203743, pressureDrop: 4 },
      { flow: 0.9906323185011708, pressureDrop: 13.166666666666671 },
      { flow: 1.4894613583138177, pressureDrop: 26.5 },
      { flow: 1.9953161592505855, pressureDrop: 44.666666666666664 },
      { flow: 2.3536299765807964, pressureDrop: 60.33333333333334 },
      { flow: 2.5081967213114758, pressureDrop: 66.83333333333334 },
      { flow: 2.782201405152225, pressureDrop: 80.33333333333334 },
      { flow: 3.0000000000000004, pressureDrop: 92.5 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.4707259953161592, pressureDrop: 2.333333333333343 },
      { flow: 0.9906323185011708, pressureDrop: 8.5 },
      { flow: 1.4894613583138177, pressureDrop: 17.33333333333333 },
      { flow: 1.9953161592505855, pressureDrop: 29 },
      { flow: 2.5081967213114758, pressureDrop: 43.83333333333334 },
      { flow: 3.0000000000000004, pressureDrop: 60.83333333333334 },
      { flow: 3.505854800936768, pressureDrop: 81 },
      { flow: 3.730679156908666, pressureDrop: 90.33333333333334 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.4707259953161592, pressureDrop: 1.6666666666666714 },
      { flow: 0.9906323185011708, pressureDrop: 5.5 },
      { flow: 1.4894613583138177, pressureDrop: 11 },
      { flow: 1.9953161592505855, pressureDrop: 18.33333333333333 },
      { flow: 2.5011709601873537, pressureDrop: 27.5 },
      { flow: 2.9929742388758784, pressureDrop: 38.000000000000014 },
      { flow: 3.498829039812647, pressureDrop: 51.00000000000001 },
      { flow: 4.004683840749414, pressureDrop: 64.83333333333334 },
      { flow: 4.503512880562061, pressureDrop: 81.33333333333334 },
      { flow: 4.995316159250586, pressureDrop: 100 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.46370023419203743, pressureDrop: 1.5 },
      { flow: 0.9976580796252928, pressureDrop: 4.666666666666671 },
      { flow: 1.4964871194379392, pressureDrop: 8.833333333333329 },
      { flow: 2.0023419203747075, pressureDrop: 15.166666666666671 },
      { flow: 2.5081967213114758, pressureDrop: 22.333333333333343 },
      { flow: 3.0070257611241216, pressureDrop: 31.16666666666667 },
      { flow: 3.498829039812647, pressureDrop: 41.333333333333336 },
      { flow: 4.004683840749414, pressureDrop: 52.50000000000001 },
      { flow: 4.503512880562061, pressureDrop: 65.66666666666667 },
      { flow: 5.009367681498829, pressureDrop: 79.33333333333334 },
      { flow: 5.522248243559719, pressureDrop: 95.33333333333334 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.477751756440281, pressureDrop: 1.3333333333333428 },
      { flow: 0.9976580796252928, pressureDrop: 3 },
      { flow: 1.4824355971896956, pressureDrop: 5.833333333333343 },
      { flow: 1.9953161592505855, pressureDrop: 9.666666666666671 },
      { flow: 2.5011709601873537, pressureDrop: 14.5 },
      { flow: 3.0000000000000004, pressureDrop: 20.166666666666657 },
      { flow: 3.498829039812647, pressureDrop: 26.66666666666667 },
      { flow: 4.004683840749414, pressureDrop: 34.33333333333333 },
      { flow: 4.503512880562061, pressureDrop: 42.333333333333336 },
      { flow: 5.0023419203747075, pressureDrop: 51.333333333333336 },
      { flow: 5.508196721311475, pressureDrop: 61.666666666666664 },
      { flow: 6.014051522248244, pressureDrop: 72.66666666666667 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.4707259953161592, pressureDrop: 1 },
      { flow: 0.9906323185011708, pressureDrop: 2 },
      { flow: 1.4964871194379392, pressureDrop: 4.333333333333343 },
      { flow: 1.9953161592505855, pressureDrop: 7 },
      { flow: 2.5081967213114758, pressureDrop: 10.666666666666671 },
      { flow: 2.9929742388758784, pressureDrop: 14.5 },
      { flow: 3.498829039812647, pressureDrop: 18.83333333333333 },
      { flow: 4.0117096018735365, pressureDrop: 24.66666666666667 },
      { flow: 4.503512880562061, pressureDrop: 30.333333333333343 },
      { flow: 5.009367681498829, pressureDrop: 36.66666666666667 },
      { flow: 5.515222482435598, pressureDrop: 43.66666666666668 },
      { flow: 6.0070257611241225, pressureDrop: 50.833333333333336 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.5111333023843002, pressureDrop: 0.37397676150653325 },
      { flow: 1.0220662153451539, pressureDrop: 1.1347886058573877 },
      { flow: 1.5133008479812435, pressureDrop: 2.4379043274095977 },
      { flow: 2.023472281133002, pressureDrop: 4.66932405307648 },
      { flow: 2.5269306685993116, pressureDrop: 7.365313258766207 },
      { flow: 3.0172835877722375, pressureDrop: 10.371238106052758 },
      { flow: 3.513828540129652, pressureDrop: 13.918798865795864 },
      { flow: 4.010173103063621, pressureDrop: 17.85336169956949 },
      { flow: 4.499884776081518, pressureDrop: 22.09769318375376 },
      { flow: 4.995748404399215, pressureDrop: 26.961060995200672 },
      { flow: 5.504276644278715, pressureDrop: 32.36589772791791 },
      { flow: 5.9869145706489615, pressureDrop: 37.77140242537999 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.4982282235143629, pressureDrop: 0.296910329072837 },
      { flow: 1.0221062932298435, pressureDrop: 1.057388191051281 },
      { flow: 1.519813504243246, pressureDrop: 2.360336921417286 },
      { flow: 2.0303055604725184, pressureDrop: 3.972553328635314 },
      { flow: 2.5211794921464046, pressureDrop: 5.972272783442492 },
      { flow: 3.0248783469208496, pressureDrop: 8.203859500295572 },
      { flow: 3.515271343978465, pressureDrop: 11.13238393277603 },
      { flow: 4.011976607874637, pressureDrop: 14.370343033294702 },
      { flow: 4.501968826085358, pressureDrop: 18.072871613836227 },
      { flow: 4.998273311134638, pressureDrop: 22.08483486241596 },
      { flow: 5.507282485630408, pressureDrop: 26.56086661745993 },
      { flow: 5.990401346616926, pressureDrop: 31.037566337248716 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.5046206461222976, pressureDrop: 0.4515441674988452 },
      { flow: 1.0221864489992218, pressureDrop: 0.9025873614390605 },
      { flow: 1.5201341273207598, pressureDrop: 1.7411336029684392 },
      { flow: 2.0243139167114763, pressureDrop: 3.043915342148246 },
      { flow: 2.5348059729407484, pressureDrop: 4.656131749366267 },
      { flow: 3.0192073262373214, pressureDrop: 6.65601819535965 },
      { flow: 3.5164736805191423, pressureDrop: 8.810371488592835 },
      { flow: 4.013539645377517, pressureDrop: 11.351726855856548 },
      { flow: 4.50401279820451, pressureDrop: 14.125450458724792 },
      { flow: 5.000718062100682, pressureDrop: 17.363409559243465 },
      { flow: 5.510128015443345, pressureDrop: 21.065437166226367 },
      { flow: 5.974390231683571, pressureDrop: 24.45903205228828 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.5175658028769241, pressureDrop: 0.45121018512643474 },
      { flow: 1.0285788716071567, pressureDrop: 1.0572211998650758 },
      { flow: 1.5137817825975146, pressureDrop: 1.5090993497363172 },
      { flow: 2.0246746176736794, pressureDrop: 2.3473116088932855 },
      { flow: 2.529014718603152, pressureDrop: 3.3404916888486653 },
      { flow: 3.0138970065159962, pressureDrop: 4.41157315716876 },
      { flow: 3.5115240617600203, pressureDrop: 5.869322717146993 },
      { flow: 4.028528774251295, pressureDrop: 7.403971718372709 },
      { flow: 4.506657938594, pressureDrop: 9.017023081521764 },
      { flow: 5.004044526529889, pressureDrop: 10.939175130336622 },
      { flow: 5.507703303419645, pressureDrop: 13.248162261995809 },
      { flow: 5.9855118446848365, pressureDrop: 15.480416943593724 }
    ],
  ...
  },
  {
    ...
    points: [
      { flow: 0.5111733802689894, pressureDrop: 0.29657634670042654 },
      { flow: 1.0287792610306026, pressureDrop: 0.6702191258345422 },
      { flow: 1.5140623277903393, pressureDrop: 0.9672964460935702 },
      { flow: 2.0250753965205717, pressureDrop: 1.5733074608322184 },
      { flow: 2.5231032306114884, pressureDrop: 2.2570528727493766 },
      { flow: 3.0145783305557137, pressureDrop: 3.0957661054649535 },
      { flow: 3.518998587254565, pressureDrop: 3.93414535580812 },
      { flow: 4.023098220875902, pressureDrop: 5.39172792460014 },
      { flow: 4.5143729313966805, pressureDrop: 6.6174432313462574 },
      { flow: 5.012080142410083, pressureDrop: 7.920391961712262 },
      { flow: 5.522612276524044, pressureDrop: 9.455207954124184 },
      { flow: 6.00082159663613, pressureDrop: 10.913458487661025 }
    ],
